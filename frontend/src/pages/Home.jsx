  ...
  return (
    <div>
          ...
          <main className="flex-grow">
            <div className="relative min-h-[calc(100vh-125px)] flex items-center justify-center">
              ...
              <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 text-center text-white z-10">
                <div className="max-w-3xl mx-auto">
                  ...
                  <Link to="/add/product" className="inline-flex items-center justify-center h-12 px-6 rounded-lg text-base font-bold bg-[#1173d4] text-white hover:opacity-90 transition-opacity transform hover:scale-105">
                    Get Started
                  </Link>
                </div>
              </div>
